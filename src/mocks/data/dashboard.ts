...
export const mockTADashboard = {
  ...
  recentActivities: [
    { id: 1, type: 'ENROLLMENT', message: '홍길동님이 React 기초부터 실전까지 과정에 등록했습니다.', createdAt: '2024-03-28T15:30:00' },
    { id: 2, type: 'COMPLETION', message: '김철수님이 AWS 클라우드 입문 과정을 수료했습니다.', createdAt: '2024-03-28T14:20:00' },
    { id: 3, type: 'REVIEW', message: '이영희님이 TypeScript 마스터 클래스 과정에 5점 리뷰를 남겼습니다.', createdAt: '2024-03-28T12:10:00' },
    { id: 4, type: 'ENROLLMENT', message: '박민수님이 Python 데이터 분석 과정에 등록했습니다.', createdAt: '2024-03-28T11:00:00' },
    { id: 5, type: 'USER', message: '새로운 사용자 정다은님이 가입했습니다.', createdAt: '2024-03-28T10:30:00' },
  ],
  courseStats: [
  ...
  recentCourses: [
    {
      ...
      progress: 65,
      lastAccessedAt: '2024-03-28T15:30:00',
    },
    {
      enrollmentId: 2,
      ...
      progress: 30,
      lastAccessedAt: '2024-03-27T11:20:00',
    },
  ],
  upcomingDeadlines: [
    { enrollmentId: 1, courseName: 'React 기초부터 실전까지', deadline: '2024-05-31', daysLeft: 64 },
    { enrollmentId: 2, courseName: 'TypeScript 마스터 클래스', deadline: '2024-06-15', daysLeft: 79 },
  ],
  recommendedCourses: [
    {
      id: 4,
